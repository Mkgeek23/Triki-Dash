...
- **Po realizacji zadań z planu zaktualizuj dokumentację.** Gdy wykonujesz zadania z `plans/`, po zakończeniu zaktualizuj odpowiednie pliki w `docs/` i oznacz zadania jako `[x]` w planie.
